...
def sha_256(input_string):
    ...
    #print('a=',int(a,2),'b=',int(b,2),'c=',int(c,2),'d=',int(d,2),'e=',int(e,2),'f=',int(f,2),'g=',int(g,2),'h=',int(h,2))
    for i in range(0,64):
        if i <16:
            '''if i<3:
                print(int(rotate_right(e,6),2),int(rotate_right(e,11),2),int(rotate_right(e,25),2))
                print(int(xor_2str(rotate_right(e,6),rotate_right(e,11)),2))
                #print(int(xor_2str(xor_2str(rotate_right(e,6),rotate_right(e,11)),rotate_right(e,25)),2))'''
            t_1=mod_32_addition([int(h,2),int(e_1(e),2),int(Ch(e,f,g),2),int(sha_256_constants[i],16),int(w_t[i],2)])
            #if i<1:
                #print(int(rotate_right(e,6),2))
                #print(int(e_1(e),2),int(sha_256_constants[i],16))
                #print(int(h,2)+int(e_1(e),2)+int(Ch(e,f,g),2)+int(sha_256_constants[i],16))#,int(w_t[i],2))
            t_2=mod_32_addition([int(e_0(a),2),int(Maj(a,b,c),2)])
            print('count=',i)
            #print("ma=",int(Maj(a,b,c),2)," e0=",int(e_0(a),2)," Ch=",int(Ch(e,f,g),2)," e1=",int(e_1(e),2))
            h=g
            g=f
            f=e
            ...
            a=bin_32bit(a)
            e=bin_32bit(e)
            #print(int(a,2)," ",int(b,2)," ",int(c,2)," ",int(d,2)," ",int(e,2)," ",int(f,2)," ",int(g,2)," ",int(h,2))
        ...
        if i > 15:
            ...
            #if i==17:
                #print(int(rotate_right(e,6),2),int(rotate_right(e,11),2),int(rotate_right(e,25),2))
                #print(int(e,2),int(f,2),int(g,2))
                #print(int(and_2str(e,f),2),int(and_2str(not_str(e),g),2))
                #print(int(Ch(e,f,g),2))
                #print(int(xor_2str(rotate_right(e,6),rotate_right(e,11)),2))
          #print("ma=",int(Maj(a,b,c),2)," e0=",int(e_0(a),2)," Ch=",int(Ch(e,f,g),2)," e1=",int(e_1(e),2))
            #print('count=',i)
            if i==31:
                print('                              ',int(sha_256_constants[i],16),(w_t[i]))
            #if i==19:
                #print(int(rotate_right(e,6),2),int(rotate_right(e,11),2),int(rotate_right(e,25),2))
            if i==31:
                print(int((w_t[i-2]),2),((w_t[i-15])))
                #print(int(rotate_right(w_t[i-2],17),2))
                print(int(xor_2str(xor_2str(rotate_right(w_t[i-15],7),rotate_right(w_t[i-15],18)),shift_right(w_t[i-15],3)),2))
                print(int(xor_2str(xor_2str(rotate_right(w_t[i-2],17),rotate_right(w_t[i-2],19)),shift_right(w_t[i-2],10)),2))
                print((rotate_right(w_t[i-15],7)))
                print(int(rotate_right(w_t[i-15],18),2))
                print(int(shift_right(w_t[i-15],3),2))
            if i>=30 and i<32:
                print('count=',i)
                print("ma=",int(Maj(a,b,c),2)," e0=",int(e_0(a),2)," Ch=",int(Ch(e,f,g),2)," e1=",int(e_1(e),2))
                print(int(a,2)," ",int(b,2)," ",int(c,2)," ",int(d,2)," ",int(e,2)," ",int(f,2)," ",int(g,2)," ",int(h,2))
